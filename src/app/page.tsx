...
export default async function HomePage() {
  ...
  if (!profile) {
    ...
    profile = {
      ...
      updatedAt: new Date(),
      links: [
        { id: '1', title: 'Tiktok', url: 'https://tiktok.com/@onlyvirtus', icon: 'tiktok', category: 'social', sectionTitle: '', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 0, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
        { id: '2', title: 'Youtube', url: 'https://www.youtube.com/channel/UCS4s9c5ADSshIhr3BnlTlVg', icon: 'youtube', category: 'social', sectionTitle: '', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 1, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
        { id: '3', title: 'Astra Points', url: 'https://astrapoints.com', icon: 'coins', category: 'custom', sectionTitle: 'Top Up', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 2, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
        { id: '4', title: 'Mabar VIP Queue', url: '/mabarvip', icon: 'gamepad', category: 'custom', sectionTitle: '', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 3, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
      ],
      banners: [],
      topButtons: [],
      codes: [],
