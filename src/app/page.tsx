  ...
  if (!profile) {
    ...
    profile = {
      ...
      links: [
        ...
        { id: '2', title: 'Youtube', url: 'https://www.youtube.com/channel/UCS4s9c5ADSshIhr3BnlTlVg', icon: 'youtube', customIconUrl: '', layout: 'row', textAlign: 'left', itemAlign: 'left', iconWidth: 48, category: 'social', sectionTitle: '', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 1, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
        { id: '3', title: 'Astra Points', url: 'https://astrapoints.com', icon: 'coins', customIconUrl: '', layout: 'row', textAlign: 'left', itemAlign: 'left', iconWidth: 48, category: 'custom', sectionTitle: 'Top Up', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 2, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
        { id: '4', title: 'Mabar VIP Queue', url: '/mabarvip', icon: 'gamepad', customIconUrl: '', layout: 'row', textAlign: 'left', itemAlign: 'left', iconWidth: 48, category: 'custom', sectionTitle: '', sectionBgColor: '', sectionTextColor: '', waCustomMessage: '', isEnabled: true, orderIndex: 3, profileId: 'profile', createdAt: new Date(), updatedAt: new Date() },
      ],
      banners: [],
      topButtons: [],
      codes: [],
